...
function HeaderTrainer() {
  ...
  async function handleLogout() { //asunc fucntions logs out user
...
<nav className="navbar navbar-expand-lg bg-dark sticky-top Headcomp">
  <div className="container-fluid">
        ...
        <div className="d-flex container-fluid justify-content-between " style={{}}>
      ...
      <div className="container collapse navbar-collapse" style={{marginLeft:"20px"}} id="navbarNav">
