...
function Signup() {
  ...
  async function handleSubmit(e){
    ...
    await signup(emailRef.current.value, passwordRef.current.value, displayNameRef.current.value)// Here we call the signup function, which is in AuthContexts file with certain parameters. If signup does not work then error will be outputted
    navigate('/') //If signup is successful, then user is navigated to the user page, else they get an error as signup wouldn't have been successful.
